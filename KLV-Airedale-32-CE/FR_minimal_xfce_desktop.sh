...
wget -c https://github.com/sofijacom/linux-6.11.1.arch1-1-x86_64/releases/download/kernel-linux-6.12.60_1/initrd.gz
wget -c https://github.com/sofijacom/linux-6.11.1.arch1-1-x86_64/releases/download/kernel-linux-6.12.60_1/vmlinuz
wget -c https://github.com/sofijacom/linux-6.11.1.arch1-1-x86_64/releases/download/kernel-linux-6.12.60_1/00modules_6.12.60_1.sfs
wget -c https://github.com/sofijacom/linux-6.11.1.arch1-1-x86_64/releases/download/kernel-linux-6.12.60_1/01firmware_6.12.60_1.sfs
...
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLV-Airedale-32/16gtkdialogGTK3_filemnt64.sfs
